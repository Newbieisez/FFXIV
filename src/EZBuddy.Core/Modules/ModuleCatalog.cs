...
public static class ModuleCatalog
{
    ...
    [
        ...
        new("desynthesis", "Mass Desynthesis", EZModuleDomain.Economy, "Rule-based desynthesis of explicitly approved overflow items with protected-item and value guardrails.", ModuleMaturity.Planned, DestructiveActionsRequireExplicitOptIn: true),
        ...
        new("retainers", "Retainers & Ventures", EZModuleDomain.Economy, "Venture collection/reassignment, venture plans, entrust, gil collection and shared bell coordination.", ModuleMaturity.InDevelopment, SupportsLisbeth: true, SupportsOrderBot: true, DestructiveActionsRequireExplicitOptIn: true),
        ...
        new("wondrous-tails", "Wondrous Tails", EZModuleDomain.WeeklyDaily, "Weekly book tracking, eligible duty planning, Second Chance budgeting and turn-in reminders/workflows.", ModuleMaturity.Planned, RequiresMagitek: true),
        ...
        new("gold-saucer", "Gold Saucer & Arcade", EZModuleDomain.GoldSaucer, "MGP goals, supported minigame activities, collection targets and spend caps.", ModuleMaturity.Planned),
        ...
        new("dailies", "Dailies & Tribes", EZModuleDomain.WeeklyDaily, "Reset-aware tribe, custom delivery, hunt, GC and other daily/weekly task planning.", ModuleMaturity.Foundation, RequiresMagitek: true, SupportsLisbeth: true, SupportsOrderBot: true),
        ...
        new("notifications", "Webhook & Push Alerting", EZModuleDomain.Notifications, "Opt-in outbound notifications for configured drops, clears, stuck states, inventory halts, social alerts and engine failures.", ModuleMaturity.Planned)
    ];
