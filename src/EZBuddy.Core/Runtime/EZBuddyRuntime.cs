...
public static class EZBuddyRuntime
{
    ...
    private static readonly Lazy<NotificationHub> NotificationsLazy = new(() => new NotificationHub());
    ...
    public static NotificationHub Notifications => NotificationsLazy.Value;
